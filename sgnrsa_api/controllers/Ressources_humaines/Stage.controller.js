...
const createStage = async (req, res) => {
  ...
  try {
    const {
      ID_ETUD,ID_ENCA,ID_TUT,DATE_DEBUT,DATE_FIN,SUJET,RAPPORT,EVALUATION,COMMENTAIRE
    } = req.body;
    const data = { ...req.body };
    ...
    const sortColumns = {
      ...
      tuteur: {
        ...
        fields: {
          ...
          EMAIL: 'EMAIL',
          TELEPHONE: 'TELEPHONE',
          // DATE_INSERTION: 'tuteur.DATE_INSERTION'
        }
      }
